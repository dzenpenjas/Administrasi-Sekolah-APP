...
import { WorkflowStepId, TeacherProfile, SchoolData, AcademicSetting, CPData, TPData, ATPData } from '../types';
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-slate-300 font-medium">{profile.status}</span>
            </div>
            <h2 className="text-lg sm:text-xl font-bold text-white tracking-tight flex items-center gap-2">
              {profile.name}
              {profile.nip && (
                <span className="text-xs font-normal text-slate-400">({profile.nip})</span>
              )}
            </h2>
            <p className="text-xs text-blue-200 flex items-center gap-1.5">
              ...
              <span className="text-slate-300">{school.district || school.regency}</span>
            </p>
          </div>
