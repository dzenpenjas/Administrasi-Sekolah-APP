...
export async function generateAssessment(context: DocumentGenerationContext): Promise<GeneratedDocumentResult> {
  ...
  docChildren.push(
    ...createDocumentHeader(
      'PANDUAN, INSTRUMEN ASESMEN & RUBRIK PENILAIAN',
  ...
  const kisiRows = tpItems.map((item, idx) => {
    return new TableRow({
      children: [
  ...
  const sampleStudents = ['1. ........................................', '2. ........................................', '3. ........................................', '4. ........................................'];
  const formatifRows = sampleStudents.map((st, idx) => {
    return new TableRow({
      children: [
        createTableDataCell(`${idx + 1}`, 6, AlignmentType.CENTER),
        createTableDataCell(st, 30),
        createTableDataCell('SB / B / C / K', 16, AlignmentType.CENTER),
        createTableDataCell('SB / B / C / K', 16, AlignmentType.CENTER),
        createTableDataCell('SB / B / C / K', 16, AlignmentType.CENTER),
  ...
  const fileName = `ASESMEN_DAN_RUBRIK_${cleanSubject}_${cleanGrade}_${new Date().toISOString().slice(0, 10)}.docx`;
